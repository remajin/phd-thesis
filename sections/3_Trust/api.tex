...
\end{lstlisting}
\caption{Asynchronous version of the example in \ref{tab:minimal}.
...
\ref{tab:minimal_async} demonstrates the use of {\tt apply\_then()} following the pattern of \ref{tab:minimal}.
...
Blocking in delegated context means putting the trustee itself to sleep, preventing it from serving other requests, potentially resulting in deadlock as shown in \ref{fig:nested}.
...
This is discussed in more detail in Section \ref{sg:noref}.
