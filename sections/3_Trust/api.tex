...
Table~\ref{tab:minimal_async} demonstrates the use of {\tt apply\_then()} following the pattern of Table~\ref{tab:minimal}.
...
Blocking in delegated context means putting the trustee itself to sleep, preventing it from serving other requests, potentially resulting in deadlock as shown in Figure~\ref{fig:nested}.
...
\begin{figure*}
  \centering\
  \includegraphics[height=2in]{figures/launch}
...
This is discussed in more detail in Section Figure~\ref{sg:noref}.
