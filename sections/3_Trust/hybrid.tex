...
Figure~\ref{f:kvstore_tput} shows that delegation's performance advantage depends on the workload and lock contention 
...
contented system while keeping the overhead during low contention workload to a minimum. Figure~\ref{hybrid:fig:motivation-95r} 
