...
\ref{f:minimal} illustrates this through a minimal Rust example.
...
For readers unfamiliar with Rust, \ref{f:minimal_mutex} illustrates the rough equivalent of \ref{f:minimal_threads}, but using conventional Rust primitives instead of \trust{}. Note the similarity in terms of legibility and verbosity. 
...
In Sectin \ref{s:nesting}, we describe multiple ways around this constraint.