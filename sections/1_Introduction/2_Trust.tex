...
\ref{tab:minimal_threads} shows an example where a counter is incremented by two different threads.
...
\ref{tab:minimal_mutex} illustrates the rough equivalent of \ref{tab:minimal_threads}, but using conventional Rust 
