...
In this paper, we take a closer look at current barriers to delegation performance, and propose design 
improvements that provide excellent delegation performance across a wide range of conditions. 

Moreover, a single client thread may have multiple outstanding requests to one or more trustees, providing both parallelism and transparent batching benefits.