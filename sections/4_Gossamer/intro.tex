...
This chapter utilizes the approach presented in \trust{} \cite{ahmad2024trust}, which in turn extends the work 
...
traversal. \name{} partialy overcomes that by using RDMA. RDMA provides sub-micro second one way latency that is comparable 
