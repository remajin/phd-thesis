...
closures to comply with the NoRef trait as shown in \ref{fig:trustntrustee}. This is implemented using the code 
shown in \ref{tab:auto}. This however limits severely what 
...
serialized along with the closure as an extra parameter to the delegated closure. \ref{tab:noref} shows a code 
...
of this message is shown in \ref{fig:error}.
...
$num\_machines^2 \times num\_threads\_per\_machine$. \ref{fig:qp_scaling} shows the reduction in the number of 
connections gained by using this design. \ref{fig:qp_scaling_6m} shows an experiment that demonstrates 
