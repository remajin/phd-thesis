...
results in the servers spending more time processing the TCP communication. This is evidenced by perf showing that 
...
stores in this experiment. We also include a line showing how it would scale were it to have the same per thread 
performance as Hydra.
...
with it despite being a general framework. Similarly, \ref{fig:sssp_size} shows \name{} achieving comparable 
performance to graph500 across a range of graph sizes with 384 threads across 12 machines.
