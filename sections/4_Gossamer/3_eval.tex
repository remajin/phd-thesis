...
crate ``dashmap" version ``6.1.0" \cite{dashmap} and a hashmap with 4096 shards protected by a readers-writers lock referred as 
rwlock below. In case of Redis, we disable replication and disk backup and provide two I/O threads per instance. The key space 
