...
We present \trust{}, a general, type- and memory-safe alternative to locking in concurrent programs. Instead of 
...
Locking is often said to offer a limited throughput {\it per lock}. \trust{} is based on delegation, a 
...
as well as {\tt memcached}, in situations with high lock contention. Moreover, \trust{} is competitive with 
...
\input{sections/2_Trust/design}
\input{sections/2_Trust/eval}
