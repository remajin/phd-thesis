...
# a = 0
# cdf(x) = (a = (x+a),a/500)
plot "~/thesis/figures/data/hydra_r6615.txt" u 2:8 with linespoint dashtype 1 pointtype 1 title "hydra server sharded",\
	"~/thesis/figures/data/client_sharded_r6615.txt" u 2:8 with linespoint dashtype 1 pointtype 2 title "client sharded",\
