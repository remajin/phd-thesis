...
plot "~/thesis/figures/data/erpc_t56.txt" u 1:4 with linespoint dashtype 1 pointtype 2 title "eRPC",\
	"~/thesis/figures/data/gsm_loaded_latency_k56_l150.txt" u 8:20 with linespoint dashtype 1 pointtype 6 title "Gossamer",\
